...
if (isset($_POST)) {
	...
	$money = filterString($_POST['money']);
    $theme_mode = filterString($_POST['theme']);
    ...
    die();
	 ...
	 tinmsg = '$tinmsg', tacmsg = '$tacmsg', icmsg = '$icmsg', userstac = '$tac', usersic = '$ic', userstin = '$tin',
	  enable_cot_imf = '$enable_cot_imf', rest_msg = '$rest_msg', crypto = '$crypto', money = '$money', bots = '$bots', country = '$country', site_url ='$site_url' , kyc = '$kyc', visual_card ='$visual_card', theme ='$theme_mode'  WHERE id = 1");
