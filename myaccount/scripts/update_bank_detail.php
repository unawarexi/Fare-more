...
if (empty($accountnumber) || empty($cot) || empty($imf)) {
 	...
 	$query = $conn->query("UPDATE users SET accounttype = '$accounttype', daily_limit = '$daily_limit', accountnumber = '$accountnumber', usercurrency = '$usercurrency', cot = '$cot', imf = '$imf', secretCode = '$secretCode' WHERE id = '$id' ");
