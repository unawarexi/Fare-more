                                        ...
                                        ?>
                                                 <tr class="nk-tb-item">
                                                        ...
                                                        <td class="nk-tb-col">
                                                            <div class="user-card">
                                                                <div class="user-info">
                                                                    <span class="tb-lead"><?php echo $password ?><span class="dot dot-success d-md-none ml-1"></span></span>
                                                                    <span></span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="nk-tb-col nk-tb-col-tools">
                                                            <ul class="nk-tb-actions gx-1">
                                                                ...
                                                                <li class="nk-tb-action-hidden">
                                                                    <a href="delete_user?accountnumber=<?php echo$accountnumber ?>&id=<?php echo$userid?>" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Delete Account">
