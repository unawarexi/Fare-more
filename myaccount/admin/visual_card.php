         ...
         <div class="nk-block-head-sub">
           ...
           <div class="nk-block-between-md g-4 card-bordered">
             <div class="nk-block-head-content">
              <h4 class="nk-block-title fw-normal">Virtual Card  Management.</h4>
 ...
 <div class="modal fade" tabindex="-1" id="approve<?php echo$rows['id'] ?>" >
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header text-white" style="background-color:#3140fc; color: white;">
                <h5 class="modal-title">Approve Virtual Card Request</h5>
            </div>
            <div class="modal-body">
               <strong>You are about to approve  Virtual Card Request made by <?php echo"$firstname $lastname $middlename"; ?></strong>
              </div>
 ...
 <div class="modal fade" tabindex="-1" id="reject<?php echo$rows['id'] ?>" >
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header text-white" style="background-color:#3140fc; color: white;">
                <h5 class="modal-title">Reject Virtual Card Request</h5>
            </div>
            <div class="modal-body">
               <strong>You are about to Reject  Virtual Card Request made by <?php echo"$firstname $lastname $middlename"; ?></strong>
              </div>
 ...
 <div class="modal fade" tabindex="-1" id="deactivate<?php echo$rows['id'] ?>" >
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header text-white" style="background-color:#3140fc; color: white;">
                <h5 class="modal-title">Deactivate Virtual Card</h5>
            </div>
            <div class="modal-body">
               <strong>You are about to Deactivate   Virtual Card owned by <?php echo"$firstname $lastname $middlename"; ?></strong>
              </div>
 ...
 <div class="modal fade" tabindex="-1" id="activate<?php echo$rows['id'] ?>" >
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header text-white" style="background-color:#3140fc; color: white;">
                <h5 class="modal-title">activate Virtual Card</h5>
            </div>
            <div class="modal-body">
               <strong>You are about to activate   Virtual Card owned by <?php echo"$firstname $lastname $middlename"; ?></strong>
              </div>
 ...
 <div class="modal fade" tabindex="-1" id="delete<?php echo$rows['id'] ?>" >
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header text-white" style="background-color:#3140fc; color: white;">
                <h5 class="modal-title">Delete Virtual Card</h5>
            </div>
            <div class="modal-body">
               <strong>You are about to Delete  Virtual Card owned by <?php echo"$firstname $lastname $middlename"; ?></strong>
              </div>
