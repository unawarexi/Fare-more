...
<body class="nk-body bg-white has-sidebar <?php if($theme_mode == "dark"){
  echo "dark-mode"; 
} 
?>">
                                ...
                                <ul class="nk-menu">
                                 ...
                                 <?php  if ($visual_card == 1) { ?>
                                   ...
                                   <?php  }?>
                                    ...
                                    ?>
                                 <li class="nk-menu-item">
                                         <a href="auth_codes" class="nk-menu-link">
                                            <span class="nk-menu-icon"><em class="icon ni ni-security"></em></span>
                                            <span class="nk-menu-text">Manage Auth Code Name</span>
                                        </a>
                                    </li><!-- .nk-menu-item -->
                                     <li class="nk-menu-item">
                                ...
                                <div class="nk-news-list">
                                    <a class="nk-news-item" href="#">
                                        ...
                                        <div class="nk-news-text">
                                            <p>Do you know the latest update of Covid-19? <span> A overview of our is now available on YouTube</span></p>
