...
<div class="card card-bordered s-4 col-lg-12 p-0">
 <div class="card-header font-weight-bold text-light" style="background-color:#3140fc;">
...
<b>Banking  Details</b>
  ...
  <div class="col-md-4">
   ...
   <div class="col-md-12 ">
   <div class="form-group">
    <label class="form-label" for="phone-no">Daily Transaction Limit</label>
     <input type="text" value="5000" class="form-control" id="daily_limit" name="daily_limit" placeholder="Daily Transaction Limit">
    </div>
   </div>
</div>
    ...
    $('.regUser').click(function (e) {
      ...
      $.ajax
        ({
          ...
          data: {"firstname": firstname, "daily_limit": daily_limit, "middlename": middlename, "lastname": lastname, "countryId": countryId, "stateId": stateId, "cityId": cityId, "zipcode": zipcode,
