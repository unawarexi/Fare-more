<?php
$debitBody = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
$creditBody = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml">
    <head>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="x-apple-disable-message-reformatting" />
                  ...
                  <tr>
                    <td class="content-cell">
                      ...
                      <h2>Dear '.$accountholder.',</h2>
                        ...
                        <p><b>Details of the transaction are shown below;</b></p>
                             <b>Account Number: '.$renumber.'</b><br>
                            <b>Account Name: '.$accountholder.'</b><br>
                             <b>Description: '.$description.'</b><br>
                             <b>Total Amount: '.$money.' '.$amount.'</b><br>
                             <b>Date: '.date("d M Y, H:i a").'</b><br>
                             <b>Available Balance: '.$money.' '.$acctBal2.'</b>
                        <!-- Sub copy -->
                        <table class="body-sub" role="presentation">
                          <tr>
                            <td>
