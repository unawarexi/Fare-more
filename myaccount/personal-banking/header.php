...
<body class="nk-body npc-crypto bg-white has-sidebar <?php 
  if($theme_user == "dark"){
  echo "dark-mode"; 
} 
                            ...
                            <div class="nk-sidebar-widget d-none d-xl-block">
                                <div class="user-account-info between-center">
                                    <div class="user-account-main">
                                        ...
                                        <div class="user-balance"><?php  echo "".number_format(currencyConverter($accountbalance,$money)).""; ?> <small class="currency currency-btc"><?php echo "$usercurrency"; ?></small></div>
                                    ...
                                    <li class="nk-menu-item">
                                      ...
                                      <li class="nk-menu-item has-sub">
                                        ...
                                        <ul class="nk-menu-sub">
                                            <li class="nk-menu-item">
                                                <a href="local_transfer" class="nk-menu-link"><span class="nk-menu-text"><?php echo$shortname ?> Transfer</span></a>
                                            </li>
                                            <li class="nk-menu-item">
                                                <a href="transfer" class="nk-menu-link"><span class="nk-menu-text">Other bank transfer</span></a>
                                            </li>
                                            <li class="nk-menu-item">
                                                <a href="wire" class="nk-menu-link"><span class="nk-menu-text">Cross-border transfer</span></a>
                                            </li>
                                        </ul><!-- .nk-menu-sub -->
                                    </li><!-- .nk-menu-item -->
                                       <li class="nk-menu-item">
                            ...
                            <div class="nk-header-tools">
                                <ul class="nk-quick-nav">
                                    <li class="dropdown user-dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                                            ...
                                            <div class="dropdown-inner">
                                                <ul class="link-list">
                                                    ...
                                                    <li><a href="activity-logs"><em class="icon ni ni-activity-alt"></em><span>Login Activity</span></a></li>
                                         <li><a href="dark"><em class="icon ni ni-moon <?php if($theme_user == "dark"){
                                         echo "text-success";  
                                        } 
                                        ...
                                        ?>"></em><span> <?php 
                                        if($theme_user == "dark"){
                                           echo "Disable Dark mode";  
                                        }
                                        else{ echo "Enable Dark mode"; }
                                        ?></span></a></li>
