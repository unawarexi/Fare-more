<?php include("header.php"); ?>
 <div class="nk-content nk-content-fluid">
               ...
               <div class="card-header font-weight-bold text-light" style="background-color:#3140fc;">Deposit a check</div>
        	  		 ...
        	  		 <div class="coin-item coin-btc"> 
        	  		 	<div class="coin-icon"> 
        	  		 		<em class="icon ni ni-sign-<?php echo strtolower($money); ?>"></em>
        	  		 		 ...
        	  		 		 <div class="coin-info"> 
        	  		 		 	<span class="coin-name"><?php echo "$accounttype";?> (<?php echo "$usercurrency";?>)</span> 
        	  		 		 	<span class="coin-text">Available Balance:<?php echo "$usercurrency ".number_format(currencyConverter($accountbalance,$money))."";?>
