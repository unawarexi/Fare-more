...
if(isset($_SESSION['pendingTransfer'])){
    $query = $conn->query("DELETE FROM pending_transcation WHERE id = '".$_SESSION['pendingTransfer']."'");
...
<div class="text-center m-3">
      <button class="btn btn-lg btn-secondary" onclick="window.print()">print</button>
  </div>
<?php
include("footer.php");
