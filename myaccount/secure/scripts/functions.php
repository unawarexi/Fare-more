...
$message = "<strong>Dear $recipient</strong><br>
Kindly contact Your account Officer for details on how to acquire your $code.<br> Thank you banking with Us. ";
...
if(mail($to, $subject, $message, $headers)){
 ...
 alertNotification("1", "2", "2", $message, $phone);
}
